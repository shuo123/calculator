...
public class CalculatorController {
	...
	public String calculate(Condition c,Model model) throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
		Result[] tr=null;
		//将百分比利率转为小数
